    ...
    public partial class _DialogMainForm : Form
    {
        ...
        private void _DialogMainForm_Resize_Manuel(object sender, EventArgs e)
        {
            try
            {
                ...
                pictureBox1.Top = smartGroupBox1.Bottom + delta;
                pictureBox1.Left = delta;

                sLWarningLatestVersion.Top = smartGroupBox1.Bottom + delta;
                sLWarningLatestVersion.Left = pictureBox1.Right + delta;

                btn_Options.Top = smartGroupBox1.Bottom + delta;
                btn_Options.Left = btn_FileSearch.Left;
                
                Button_Cancel.Top = btn_Options.Bottom + delta;
                Button_Cancel.Left = btn_Options.Left;
                
                btn_OK.Top = Button_Cancel.Top;
                btn_OK.Left = btn_Options.Left - delta - btn_OK.Width;
