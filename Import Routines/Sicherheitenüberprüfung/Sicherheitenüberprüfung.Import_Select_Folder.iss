...
SetCheckpoint "Import 1.0 - Check File Format for Import"
	select Case sFileExtension
		...
		Case "xlsx", "xls"
			SmartContext.Log.LogError sFile & " : Excel-Format ist not supported. File could not be imported."
			msgbox("Das Excel-Format wird nicht unterstützt. Die Datei konnte nicht importiert werden.")
