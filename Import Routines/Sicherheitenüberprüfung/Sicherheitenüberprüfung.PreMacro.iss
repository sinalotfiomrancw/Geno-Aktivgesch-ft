...
SetCheckpoint "FileSearchDialog 3.0 - open dialog"
	...
	Set result = dialogInvoker.PerformTask("FileSearch_Si", args)
...
SetCheckpoint "FileSearchDialog 4.1 - result ALLOK"
		...
		bSi_Bas = result.Outputs.Item("sSi_Bas").Checked
		bSi_Bas_Immo = result.Outputs.Item("sSi_Bas_Immo").Checked
		bSi_Buerg_Haft = result.Outputs.Item("sSi_Buerg_Haft").Checked
		bSi_Zwek_RK = result.Outputs.Item("sSi_Zwek_RK").Checked
		bSi_Zwek_Si_Wert = result.Outputs.Item("sSi_Zwek_Si_Wert").Checked
...
SetCheckpoint "SaveParameters 1.0 - delete project parameters"
	...
	oPara.Delete4Project "PrepareBAS"
	oPara.Delete4Project "PrepareBASIMO"
	oPara.Delete4Project "PrepareBUEHAFT"
	oPara.Delete4Project "PrepareZWERK"
	oPara.Delete4Project "PrepareZWEWE"
...
SetCheckpoint "SaveParameters 2.0 - save project parameters"
	...
	oPara.Set4Project "PrepareBAS", bSi_Bas
	oPara.Set4Project "PrepareBASIMO", bSi_Bas_Immo
	oPara.Set4Project "PrepareBUEHAFT", bSi_Buerg_Haft
	oPara.Set4Project "PrepareZWERK", bSi_Zwek_RK
	oPara.Set4Project "PrepareZWEWE", bSi_Zwek_Si_Wert
