    ...
    public partial class _DialogMainForm : Form
    {
        ...
        private void MyDialog_FormClosing(object sender, FormClosingEventArgs e)
        {
            if (this.DialogResult == DialogResult.OK)
            {
                ...
                if (string.IsNullOrEmpty(smartTextBox1.Value) || string.IsNullOrEmpty(smartTextBox2.Value) || string.IsNullOrEmpty(smartTextBox3.Value) || string.IsNullOrEmpty(smartTextBox4.Value) || string.IsNullOrEmpty(smartTextBox5.Value) || string.IsNullOrEmpty(smartTextBox6.Value) || string.IsNullOrEmpty(smartTextBox7.Value) || string.IsNullOrEmpty(smartTextBox8.Value))
                {
                    // Cancel the closing of the dialog
                    MessageBox.Show("Bitte geben Sie die erforderlichen Angaben über den Beleihungsgrenze in Prozent gem. Regelung Bank ein.");
                    e.Cancel = true;
                    return;
                }
                else
