...
SetCheckpoint "Analysis 1.0 - create Wesentliche Sicherheiten nach MaRisk-Immobilien"
	...
	sSum_BG_ImNr = oSC.UniqueFileName(sWorkingfolderName & "Summierung des Sicherheitenwerts für jede Immobiliennummer.IMD", INTERMEDIATE_RESULT)
...
'	sSum_BG_ImNr = oSC.UniqueFileName(sWorkingfolderName & "Summierung der Beleihungsgrenze für jede Immobiliennummer.IMD", INTERMEDIATE_RESULT)
'	task.OutputDBName = sSum_BG_ImNr
'	task.CreatePercentField = FALSE
'	task.UseFieldFromFirstOccurrence = TRUE
'	task.StatisticsToInclude = SM_SUM
