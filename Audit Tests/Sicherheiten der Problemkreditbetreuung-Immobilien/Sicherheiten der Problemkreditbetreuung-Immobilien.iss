...
SetCheckpoint "BuildEquation_FromToList_2"	
		...
		ErrorMessageFilterLength = "ÃœberprÃ¼fen Sie die Liste der Sachkontonummernbereiche. Ein Filterausdruck, der die fÃ¼r IDEA festgelegte maximale LÃ¤nge einer Gleichung Ã¼berschreitet, kann nicht generiert werden."
