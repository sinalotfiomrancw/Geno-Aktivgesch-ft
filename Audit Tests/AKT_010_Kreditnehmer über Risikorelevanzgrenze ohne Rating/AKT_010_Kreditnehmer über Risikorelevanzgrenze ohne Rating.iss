...
'#Region - result files
' Include the primary input file an all tag names
dim sKreditn_ü_Riskgrenz_ohne_Rating as string
Dim sKreditn_ü_Riskgrenz_ohne_Rating_per_Person As String
'#End Region
Sub Main()
	...
	call registerResult(sKreditn_ü_Riskgrenz_ohne_Rating, FINAL_RESULT, 1)
	call registerResult(sKreditn_ü_Riskgrenz_ohne_Rating_per_Person, FINAL_RESULT, 2)
...
function Analysis
SetCheckpoint "Analysis 1.0 - create sKreditn_ü_Riskgrenz_ohne_Rating"
	Set db = Client.OpenDatabase(sInputFile)
	Set task = db.Extraction
	task.IncludeAllFields
	sKreditn_ü_Riskgrenz_ohne_Rating = oSC.UniqueFileName(sWorkingfolderName & "Kreditnehmer über Risikorelevanzgrenze ohne Rating.IMD", FINAL_RESULT)
	task.AddExtraction sKreditn_ü_Riskgrenz_ohne_Rating, "", "@match(" & sRISIKOKENNZEICHEN & "; ""Normalbetreut Risk""; ""Intensivbetreut Risk""; ""Sanierung Risk""; ""Abwicklung Risk""; ""Risikorelevant"") .AND. @match(" & sVR_RATINGART & "; ""Nicht geratet""; """")"
...
SetCheckpoint "Analysis_Sum_Person 1.0 - sKreditn_ü_Riskgrenz_ohne_Rating_pro Kunde"
	Set db = Client.OpenDatabase(sKreditn_ü_Riskgrenz_ohne_Rating)
	...
	sKreditn_ü_Riskgrenz_ohne_Rating_per_Person = oSC.UniqueFileName(sWorkingfolderName & "Kreditnehmer über Risikorelevanzgrenze ohne Rating_pro Kunde.IMD", FINAL_RESULT)
	task.OutputDBName = sKreditn_ü_Riskgrenz_ohne_Rating_per_Person
