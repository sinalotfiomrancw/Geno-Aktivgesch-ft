...
SetCheckpoint "Analysis 1.1 - create sENGA_EWB_RST"
	...
	sENGA_EWB_RST_IA = oSC.UniqueFileName(sWorkingfolderName & "{SUMME EWB_RST für IA}.IMD")
...
SetCheckpoint "Analysis 1.3 - join"
	...
	sJoinMitIAundSummeEWBRST = oSC.UniqueFileName(sWorkingfolderName & "{Konten mit ENGA_BVIA & SUMME EWB_RST für IA}.IMD")
...
SetCheckpoint "Analysis 2.1 - create sENGA_EWB_RST_RV"
	...
	task.AddFieldToSummarize sNETTO_ENGAGEMENT
	task.AddFieldToTotal sEWB_RST_GEBUCHT_EUR
	sENGA_EWB_RST_RV = oSC.UniqueFileName(sWorkingfolderName & "{SUMME EWB_RST für RV}.IMD")
...
SetCheckpoint "Analysis 2.3 - join"
	...
	task.AddMatchKey sNETTO_ENGAGEMENT, sNETTO_ENGAGEMENT, "A"
	sJoinMitRVundSummeEWBRST = oSC.UniqueFileName(sWorkingfolderName & "{Konten mit ENGA_BVIA & SUMME EWB_RST für RV}.IMD")
...
SetCheckpoint "Analysis 3.1 - create sENGA_EWB_RST_RV"
	...
	task.AddFieldToSummarize sNETTO_ENGAGEMENT
	task.AddFieldToTotal sEWB_RST_GEBUCHT_EUR
	sENGA_EWB_RST_IA_RV = oSC.UniqueFileName(sWorkingfolderName & "{SUMME EWB_RST für IA und RV}.IMD")
...
SetCheckpoint "Analysis 3.3 - join"
	...
	task.AddMatchKey sNETTO_ENGAGEMENT, sNETTO_ENGAGEMENT, "A"
	sJoinMitRVIAundSummeEWBRST = oSC.UniqueFileName(sWorkingfolderName & "{Konten mit ENGA_BVIA & SUMME EWB_RST für IA und RV}.IMD")
