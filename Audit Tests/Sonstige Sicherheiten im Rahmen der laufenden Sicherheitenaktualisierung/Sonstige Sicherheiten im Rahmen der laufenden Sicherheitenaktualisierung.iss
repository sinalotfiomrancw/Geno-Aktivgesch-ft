...
SetCheckpoint "Analysis 1.0 - create Wesentliche Sicherheiten nach MaRisk-Immobilien"
	...
	sEqFilter = sSTATUS_BEARBEITUNG & " = ""A"" .AND. " & sSTATUS_SATZART & " = ""J"" .AND. " & sBELEIHUNGSGRENZE_ALS_BETRAG & "  >  " & sBWBR & " .AND. @AGE(@Date(); " & sNACHGEWIESENER_WERT_PER & ") >  " & sUEDBR
	...
	sSicherheiten_MaRisk_Immobilien = oSC.UniqueFileName(sWorkingfolderName & "Sonstige Sicherheiten im Rahmen der laufenden Sicherheitenaktualisierung.IMD", FINAL_RESULT)
