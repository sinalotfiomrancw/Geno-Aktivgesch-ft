...
'#Region - result files
' Include the primary input file an all tag names
dim sBoni5und6_Ausfallratekleiner100 as string
Dim sBoni5und6_Ausfallratekleiner100_per_Person As String
'#End Region
Sub Main()
	...
	call registerResult(sBoni5und6_Ausfallratekleiner100, FINAL_RESULT, 1)
	call registerResult(sBoni5und6_Ausfallratekleiner100_per_Person, FINAL_RESULT, 2)
...
function Analysis
SetCheckpoint "Analysis 1.0 - create sBoni5und6_Ausfallratekleiner100"
	Set db = Client.OpenDatabase(sInputFile)
	Set task = db.Extraction
	task.IncludeAllFields
	sBoni5und6_Ausfallratekleiner100 = oSC.UniqueFileName(sWorkingfolderName & "Bonitätsnoten 5 und 6 mit Ausfallrate kleiner 100 Prozent.IMD", FINAL_RESULT)
	task.AddExtraction sBoni5und6_Ausfallratekleiner100, "", "@match(" & sBONITÄTSEINSTUFUNG & "; ""5""; ""6"") .AND. " & sAUSFALLRATE_KUNDE & " < 100"
...
SetCheckpoint "Analysis_Sum_Person 1.0 - sBoni5und6_Ausfallratekleiner100_pro Kunde"
	Set db = Client.OpenDatabase(sBoni5und6_Ausfallratekleiner100)
	...
	sBoni5und6_Ausfallratekleiner100_per_Person = oSC.UniqueFileName(sWorkingfolderName & "Bonitätsnoten 5 und 6 mit Ausfallrate kleiner 100 Prozent_pro Kunde.IMD", FINAL_RESULT)
	task.OutputDBName = sBoni5und6_Ausfallratekleiner100_per_Person
