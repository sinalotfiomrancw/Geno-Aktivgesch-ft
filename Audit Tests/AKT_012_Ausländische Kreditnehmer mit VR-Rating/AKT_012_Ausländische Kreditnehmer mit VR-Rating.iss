...
'#Region - result files
' Include the primary input file an all tag names
dim sAusl_Kreditn_mit_VRRating as string
dim sAusl_Kreditn_mit_VRRating_per_Person as string
'#End Region
Sub Main()
	...
	call registerResult(sAusl_Kreditn_mit_VRRating, FINAL_RESULT, 1)
	call registerResult(sAusl_Kreditn_mit_VRRating_per_Person, FINAL_RESULT, 2)
...
SetCheckpoint "GetFileInformation 2.0 - get tags"
	...
	sLÄNDERSCHLÜSSEL = oTM.GetFieldForTag(db, "acc!LAENDERSCHLUESSEL")
...
function Analysis
SetCheckpoint "Analysis 1.0 - create sAusl_Kreditn_mit_VRRating"
	Set db = Client.OpenDatabase(sInputFile)
	Set task = db.Extraction
	task.IncludeAllFields
	sAusl_Kreditn_mit_VRRating = oSC.UniqueFileName(sWorkingfolderName & "Ausländische Kreditnehmer mit VR-Rating.IMD", FINAL_RESULT)
	task.AddExtraction sAusl_Kreditn_mit_VRRating, "", sLÄNDERSCHLÜSSEL & " <> ""0"" .AND. .Not. @match(" & sVR_RATINGART & "; ""Nicht geratet""; """")"
...
SetCheckpoint "Analysis_Sum_Person 1.0 - sAusl_Kreditn_mit_VRRating_pro Kunde"
	Set db = Client.OpenDatabase(sAusl_Kreditn_mit_VRRating)
	...
	sAusl_Kreditn_mit_VRRating_per_Person = oSC.UniqueFileName(sWorkingfolderName & "Ausländische Kreditnehmer mit VR-Rating_pro Kunde.IMD", FINAL_RESULT)
	task.OutputDBName = sAusl_Kreditn_mit_VRRating_per_Person
