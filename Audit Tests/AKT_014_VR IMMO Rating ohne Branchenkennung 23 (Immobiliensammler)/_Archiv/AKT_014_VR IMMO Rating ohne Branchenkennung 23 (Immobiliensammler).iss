...
function Analysis
SetCheckpoint "Analysis 1.0 - create sVRIMMORating_ohne_Branche_23"
	Set db = Client.OpenDatabase(sInputFile)
	...
	task.AddExtraction sVRIMMORating_ohne_Branche_23, "", ".NOT.(@between(@val(" & sBRANCHE & ");70000;70400) .OR. @match(" & sBRANCHE & ";""74153"";""74154"")) .AND. " & sVR_RATINGART & " = ""VRR Gew. Immob.""" ' 09.02.2023
