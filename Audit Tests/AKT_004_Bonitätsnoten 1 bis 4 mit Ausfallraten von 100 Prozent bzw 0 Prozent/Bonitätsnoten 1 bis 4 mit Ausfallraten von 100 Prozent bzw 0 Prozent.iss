...
'#Region - result files
' Include the primary input file an all tag names
dim sBoni1bis4_Ausfallrate100oder0 as string
Dim sBoni1bis4_Ausfallrate100oder0_per_Person As String
'#End Region
Sub Main()
	...
	call registerResult(sBoni1bis4_Ausfallrate100oder0, FINAL_RESULT, 1)
	call registerResult(sBoni1bis4_Ausfallrate100oder0_per_Person, FINAL_RESULT, 2)
...
function Analysis
SetCheckpoint "Analysis 1.0 - create sBoni1bis4_Ausfallrate100oder0"
	Set db = Client.OpenDatabase(sInputFile)
	Set task = db.Extraction
	task.IncludeAllFields
	sBoni1bis4_Ausfallrate100oder0 = oSC.UniqueFileName(sWorkingfolderName & "Bonitätsnoten 1 bis 4 mit Ausfallrate 100 oder 0 Prozent.IMD", FINAL_RESULT)
	task.AddExtraction sBoni1bis4_Ausfallrate100oder0, "", "@match(" & sBONITÄTSEINSTUFUNG & "; ""1""; ""2""; ""3""; ""4"") .AND. (" & sAUSFALLRATE_KUNDE & " = 100 .or. " & sAUSFALLRATE_KUNDE & " = 0)"
...
SetCheckpoint "Analysis_Sum_Person 1.0 - create sBoni1bis4_Ausfallrate100oder0_pro Kunde"
	Set db = Client.OpenDatabase(sBoni1bis4_Ausfallrate100oder0)
	...
	sBoni1bis4_Ausfallrate100oder0_per_Person = oSC.UniqueFileName(sWorkingfolderName & "Bonitätsnoten 1 bis 4 mit Ausfallrate 100 oder 0 Prozent_pro Kunde.IMD", FINAL_RESULT)
	task.OutputDBName = sBoni1bis4_Ausfallrate100oder0_per_Person
